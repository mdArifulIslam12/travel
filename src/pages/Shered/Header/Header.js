          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav ms-auto mb-2 mt-2 mb-lg-0">
              <li className="nav-item">
                <CustomLink to={"/"} className="navbar-links">
                  Home
                </CustomLink>
              </li>
              <li className="nav-item">
                <CustomLink to={"/tours"} className="navbar-links">
                  Tours
                </CustomLink>
              </li>
              <li className="nav-item">
                <CustomLink to={"/destination"} className="navbar-links">
                  Destination
                </CustomLink>
              </li>
              <li className="nav-item">
                {user && (
                  <CustomLink to={"/dashborad"} className="navbar-links">
                    Dashborad
                  </CustomLink>
                )}
              </li>
              <li className="nav-item">
                <CustomLink to={"/blogs"} className="navbar-links">
                  Blogs
                </CustomLink>
              </li>

              <li className="nav-item">
                <CustomLink to={"/about"} className="navbar-links">
                  About Us
                </CustomLink>
              </li>
              <li className="nav-item">
                <CustomLink to={"/contactUs"} className="navbar-links">
                  Contact Us
                </CustomLink>
              </li>
