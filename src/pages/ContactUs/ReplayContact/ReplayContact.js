        ...
        <form action="" className="mt-5 " onSubmit={handleReplayContactus}>
          <div className="input-form-name-email">
            <input
              ...
              placeholder="Name"
              name="name"
              className="replayContactUs-from"
            />
            <input
              type="email"
              placeholder="Email"
              name="email"
              className="ms-5 replayContactUs-from"
            />
          </div>
          <input
            type="number"
            ...
            id=""
            placeholder="Number"
            className="w-100 my-4 replayContactUs-from"
          />
          <textarea
            name="message"
            id=""
            className="w-100 replayContactUs-from"
            rows="10"
          ...
          <input
            type="submit"
            value="Send Message"
            className="mt-5 input-replay-submit"
          />
        </form>
      </div>
    </div>
