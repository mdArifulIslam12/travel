      ...
      <div className="row row-cols-1 row-cols-md-3 g-4 mt-5">
        <div className="col">
          <div class=" choseHoliday-img">
            <img
              src="https://travo.iamabdus.com/v1.1/wp-content/uploads/2021/04/victor-rodriguez-pWOdBS_l9LQ-unsplash-1.png"
              alt=""
              className="chooseHoliday-img"
            />
            <h3 className="details-spain">Spain</h3>
          </div>
        </div>
        {chooseHolidays.slice(4, 8).map((holiday) => (
          <div className="col">
            <div class=" news-card">
        ...
        <div className="col d-flex justify-content-center align-items-center">
          <div class=" choseHoliday-img">
            <img
              src="https://travo.iamabdus.com/v1.1/wp-content/uploads/2021/04/bawah-reserve-pPYd6u9zgAI-unsplash-1.png"
              alt=""
              className="chooseHoliday-img"
            />
